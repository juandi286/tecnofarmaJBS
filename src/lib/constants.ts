...
export const MOCK_NOTIFICATIONS: Notification[] = [
  { id: 'notif1', title: 'Actualización del Sistema v1.1', description: 'Una nueva versión de TecnoFarma está disponible con mejoras de rendimiento.', date: new Date(Date.now() - 86400000).toISOString(), read: false },
  { id: 'notif2', title: 'Alerta de Stock Bajo', description: 'Amoxicilina 250mg está por debajo del nivel mínimo de stock.', date: new Date(Date.now() - 172800000).toISOString(), read: false },
  { id: 'notif3', title: 'Categoría "Antisépticos" Añadida', description: 'Se ha añadido exitosamente una nueva categoría de producto.', date: new Date(Date.now() - 259200000).toISOString(), read: true },
];
